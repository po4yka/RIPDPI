...
- Linux-only privileged real-TUN tests use separate `linux_tun_e2e` and `linux_tun_soak` entrypoints; smoke runs 50 start/stop/handover iterations and scheduled full runs 500
