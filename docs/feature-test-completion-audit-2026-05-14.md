...
- Local post-commit checks: `git diff --check`, `cargo fmt --check`,
  ...
  smoke pack, the May 15 installed-tool Maestro/Appium reruns, the feature sign-off guard self-test, and local-network-lab
