...
Do not edit the graph below by hand — the `gradle-static-analysis` CI job regenerates it
and fails if the committed copy is stale. Regenerate and commit after changing any
