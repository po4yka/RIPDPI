...
|---|---|---|---|---|
| critical | engine | [Enforce current-only Kotlin-Rust boundary contracts](issues/enforce-current-only-boundary-contracts.md) | Boundary contract coordinator | 2026-07-10 |
...
| high | outbound | [Run Xray as managed VPN relay runtime](issues/run-xray-as-managed-vpn-relay-runtime.md) | unassigned | 2026-06-15 |
...
| low | rust-native | [Unpin russh after rsa advisory fix](issues/unpin-russh-after-rsa-advisory-fix.md) | unassigned | 2026-06-12 |
