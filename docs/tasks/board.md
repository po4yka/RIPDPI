...
| high | diagnostics | [Add diagnostics P2 path health evidence](issues/add-diagnostics-p2-path-health-evidence.md) | Codex diagnostics P2 coordinator | 2026-07-29 |
