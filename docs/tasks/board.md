...
| Priority | Area | Task | Parent epic |
| --- | --- | --- | --- |
| medium | ui | [Review landed zh-CN translation and initial human sign-off](issues/add-zh-cn-translation-and-initial-human-review.md) | localization-expansion |
...
| Priority | Area | Task | Parent epic |
| --- | --- | --- | --- |
| high | vpn | [Add tun2socks UID validation to close SO_BINDTODEVICE escape (kernel 5.7+)](issues/add-tun2socks-uid-validation-against-so-bindtodevice-bypass.md) | fail-closed-android-vpn-policy-engine |
...
| medium | ui | [Review landed fa de es fr translations and finish Arabic RTL coverage](issues/add-fa-ar-de-es-fr-translations-and-rtl-screenshot-tests.md) | localization-expansion |
