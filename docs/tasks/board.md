...
| medium | rust-native | [Investigate Hysteria2 client closing the QUIC connection after auth](issues/investigate-hysteria2-client-closes-quic-connection-after-auth.md) | — |
