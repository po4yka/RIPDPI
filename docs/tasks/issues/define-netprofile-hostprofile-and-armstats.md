...
- [x] #task Define NetProfile HostProfile and ArmStats #repo/RIPDPI #area/service #status/done ⏫

## Goal contract

<!-- goal-contract:auto -->
- **Ledger key:** `define-netprofile-hostprofile-and-armstats`
- **Verify:** `just test-module core:service`
- **Scope (only modify these + this file + the ledger):** `core/service/**`, `native/rust/crates/ripdpi-runtime-strategy/**`
