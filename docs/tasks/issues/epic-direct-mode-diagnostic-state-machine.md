...
<!-- goal-contract:auto -->
- **Ledger key:** `epic-direct-mode-diagnostic-state-machine`
...
- **Blocked-by (must be DONE in the ledger first):** `epic-direct-mode-transport-policy-and-verdicts`, `epic-encrypted-dns-and-https-svcb-classifier`, `epic-orchestration-test-posture`, `epic-privacy-preserving-strategy-learner`
