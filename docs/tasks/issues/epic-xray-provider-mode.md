...
closed_at: "2026-08-28T19:44:20Z"
...
- During final acceptance, the coordinator owns the Android Diagnostics E2E extension and all lifecycle/evidence records. The isolated `xray_session_fix` writer owns only the five child OpenSpec delta specifications, removing migrated historical blocker text while preserving requirement IDs and acceptance scope; task states and execution records remain coordinator-owned.
