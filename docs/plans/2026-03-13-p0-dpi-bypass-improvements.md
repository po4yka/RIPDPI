...
**Goal:** Implement two P0 improvements to RIPDPI's DPI bypass: (1) server hop-count TTL auto-detection to set correct fake-packet TTL, and (2) switch default DNS from Cloudflare to Google to survive Russian mobile whitelist mode.
