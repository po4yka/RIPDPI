...
data class RipDpiTextStyles(
    ...
    val screenTitleEmphasis: TextStyle,
    val body: TextStyle,
    val bodyEmphasis: TextStyle,
    val bodyEmphasisBold: TextStyle,
...
val RipDpiTypeScale =
    RipDpiTextStyles(
        ...
        screenTitleEmphasis = sansStyle(fontSize = 22, lineHeight = 28, fontWeight = FontWeight.Bold),
        ...
        bodyEmphasisBold = sansStyle(fontSize = 14, lineHeight = 20, fontWeight = FontWeight.Bold),
