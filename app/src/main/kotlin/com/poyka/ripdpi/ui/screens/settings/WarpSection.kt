    ...
    item(key = "advanced_warp") {
        ...
        AdvancedSettingsSection(
            ...
            WarpSettingsCard(
                ...
                endpointSelectionOptions = endpointSelectionOptions,
                amneziaPresetOptions = amneziaPresetOptions,
...
private fun WarpSettingsCard(
    ...
    val disabledMessage = warpDisabledMessage(uiState)
    val numericKeyboardOptions = warpNumericKeyboardOptions()

    RipDpiCard {
        WarpProfileRows(uiState)
        WarpRoutingControls(
            uiState = uiState,
            sectionEnabled = sectionEnabled,
...
@Composable
private fun WarpProfileRows(uiState: SettingsUiState) {
    SettingsRow(
...
@Composable
private fun WarpRoutingControls(
    uiState: SettingsUiState,
    sectionEnabled: Boolean,
    ...
    SettingsRow(
        ...
        subtitle = warpEnabledSubtitle(uiState),
...
@Composable
private fun WarpEndpointControls(
    uiState: SettingsUiState,
    sectionEnabled: Boolean,
    disabledMessage: String,
...
@Composable
private fun WarpManualEndpointFields(
    uiState: SettingsUiState,
    sectionEnabled: Boolean,
    disabledMessage: String,
    numericKeyboardOptions: KeyboardOptions,
...
@Composable
private fun WarpScannerControls(
    uiState: SettingsUiState,
    sectionEnabled: Boolean,
    disabledMessage: String,
    numericKeyboardOptions: KeyboardOptions,
...
@Composable
private fun WarpScannerTextFields(
    uiState: SettingsUiState,
    sectionEnabled: Boolean,
    disabledMessage: String,
    numericKeyboardOptions: KeyboardOptions,
...
@Composable
private fun WarpAmneziaControls(
    uiState: SettingsUiState,
    sectionEnabled: Boolean,
    disabledMessage: String,
    numericKeyboardOptions: KeyboardOptions,
    ...
    WarpAmneziaSuggestionRow(uiState)
    WarpAmneziaProfileRow(uiState, amneziaPresetOptions)
    if (uiState.warp.amneziaControlsEnabled) {
        WarpAmneziaControlFields(
            uiState = uiState,
            numericKeyboardOptions = numericKeyboardOptions,
            disabledMessage = disabledMessage,
            onTextConfirmed = onTextConfirmed,
...
@Composable
private fun WarpAmneziaSuggestionRow(uiState: SettingsUiState) {
    if (
...
@Composable
private fun WarpAmneziaProfileRow(
    uiState: SettingsUiState,
    amneziaPresetOptions: ImmutableList<RipDpiDropdownOption<String>>,
) {
...
@Composable
private fun WarpAmneziaControlFields(
    uiState: SettingsUiState,
    numericKeyboardOptions: KeyboardOptions,
    disabledMessage: String,
    onTextConfirmed: (AdvancedTextSetting, String) -> Unit,
) {
    WarpAmneziaJitterFields(uiState, numericKeyboardOptions, disabledMessage, onTextConfirmed)
    WarpAmneziaHeaderFields(uiState, numericKeyboardOptions, disabledMessage, onTextConfirmed)
    WarpAmneziaSizeFields(uiState, numericKeyboardOptions, disabledMessage, onTextConfirmed)
}

@Composable
private fun WarpAmneziaJitterFields(
    uiState: SettingsUiState,
...
@Composable
private fun WarpAmneziaHeaderFields(
    uiState: SettingsUiState,
    keyboardOptions: KeyboardOptions,
    disabledMessage: String,
    onTextConfirmed: (AdvancedTextSetting, String) -> Unit,
...
@Composable
private fun WarpAmneziaSizeFields(
    uiState: SettingsUiState,
    keyboardOptions: KeyboardOptions,
    disabledMessage: String,
    onTextConfirmed: (AdvancedTextSetting, String) -> Unit,
...
@Composable
private fun warpEnabledSubtitle(uiState: SettingsUiState): String =
...
@Composable
private fun warpDisabledMessage(uiState: SettingsUiState): String =
    if (uiState.warpUiAvailable) {
...
private fun warpNumericKeyboardOptions(): KeyboardOptions =
    KeyboardOptions(
