...
fun HomeRoute(
    ...
    HomeScreen(
        ...
        onBypassToggle = remember(viewModel) { { _ -> viewModel.onPrimaryConnectionAction() } },
        onVpnToggle = remember(viewModel) { { _ -> viewModel.onPrimaryConnectionAction() } },
        onDiagnosticRun = viewModel::onRunHomeFullAnalysis,
        onBypassCardClick = onOpenModeEditor,
        onVpnCardClick = onOpenModeEditor,
