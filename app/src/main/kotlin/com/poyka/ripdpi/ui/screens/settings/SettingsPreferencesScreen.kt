...
fun SettingsRoute(
    ...
    onOpenPrivacyThreatModel: () -> Unit,
    onOpenNetworkAutoProfiles: () -> Unit,
    ...
    SettingsScreen(
        ...
        actions =
            SettingsScreenActions(
                ...
                onOpenPrivacyThreatModel = onOpenPrivacyThreatModel,
                onOpenNetworkAutoProfiles = onOpenNetworkAutoProfiles,
...
internal data class SettingsScreenActions(
    ...
    val onOpenPrivacyThreatModel: () -> Unit,
    val onOpenNetworkAutoProfiles: () -> Unit = {},
