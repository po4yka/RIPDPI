...
internal object RipDpiTestTags {
    ...
    const val ConnectionActuatorFaultDetail = "connection-actuator-fault-detail"
    ...
    const val ModeEditorXrayImport = "mode-editor-xray-import"
    ...
    const val DnsOdohProxyUrl = "dns-odoh-proxy-url"
    const val DnsOdohProxyOperator = "dns-odoh-proxy-operator"
    const val DnsOdohTargetHost = "dns-odoh-target-host"
    const val DnsOdohTargetPath = "dns-odoh-target-path"
    const val DnsOdohTargetOperator = "dns-odoh-target-operator"
    const val DnsOdohConfigsHex = "dns-odoh-configs-hex"
    const val DnsOdohRetrievedAt = "dns-odoh-retrieved-at"
    const val DnsOdohTtl = "dns-odoh-ttl"
    ...
    const val OnboardingXrayImport = "onboarding-xray-import"
