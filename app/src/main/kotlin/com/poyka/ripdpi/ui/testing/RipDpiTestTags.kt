...
internal object RipDpiTestTags {
    ...
    const val DiagnosticsLiveList = "diagnostics-live-list"
    ...
    const val LogsContent = "logs-content"
    const val LogsStream = "logs-stream"
    const val LogsStreamList = "logs-stream-list"
    ...
    const val HistoryEventsList = "history-events-list"
