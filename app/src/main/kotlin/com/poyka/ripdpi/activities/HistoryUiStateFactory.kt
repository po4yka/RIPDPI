            ...
            return HistoryUiState(
                ...
                connections =
                    HistoryConnectionsUiModel(
                        ...
                        sessions = filteredConnections.toImmutableList(),
                        modes = connectionRows.map { it.serviceMode }.distinct().toImmutableList(),
                        statuses = connectionRows.map { it.connectionState }.distinct().toImmutableList(),
                ...
                groupedEvents = groupedEvents.toImmutableList(),
