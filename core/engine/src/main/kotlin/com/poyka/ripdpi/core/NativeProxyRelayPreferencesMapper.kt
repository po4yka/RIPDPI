...
internal fun buildRelayConfig(settings: AppSettings): RipDpiRelayConfig {
    ...
    return RipDpiRelayConfig(
        ...
        vmessSecurity = relay.profile.vmessSecurity,
        vmessTransport = relay.profile.vmessTransport,
        vmessWsPath = relay.profile.vmessWsPath,
        vmessWsHost = relay.profile.vmessWsHost,
        vmessGrpcService = relay.profile.vmessGrpcService,
        vmessH2Path = relay.profile.vmessH2Path,
        vmessH2Host = relay.profile.vmessH2Host,
        trojanGoSni = relay.profile.trojanGoSni,
        trojanGoWsPath = relay.profile.trojanGoWsPath,
        trojanGoWsHost = relay.profile.trojanGoWsHost,
        trojanGoMux = relay.profile.trojanGoMux,
        trojanGoInnerCipher = relay.profile.trojanGoInnerCipher,
        ...
        hysteriaV1AuthType = relay.profile.hysteriaV1AuthType,
        hysteriaV1Protocol = relay.profile.hysteriaV1Protocol,
        hysteriaV1UpMbps = relay.profile.hysteriaV1UpMbps,
        hysteriaV1DownMbps = relay.profile.hysteriaV1DownMbps,
        hysteriaV1Sni = relay.profile.hysteriaV1Sni,
        hysteriaV1Alpn = relay.profile.hysteriaV1Alpn,
