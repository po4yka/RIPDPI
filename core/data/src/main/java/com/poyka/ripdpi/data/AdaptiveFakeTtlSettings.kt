...
fun normalizeAdaptiveFakeTtlMin(value: Int): Int = value.coerceIn(1, 255)

fun normalizeAdaptiveFakeTtlMax(
    value: Int,
    min: Int = DefaultAdaptiveFakeTtlMin,
): Int = value.coerceIn(min.coerceIn(1, 255), 255)

fun normalizeAdaptiveFakeTtlFallback(
    value: Int,
    defaultValue: Int = DefaultAdaptiveFakeTtlFallback,
): Int = value.takeIf { it in 1..255 } ?: defaultValue.coerceIn(1, 255)
