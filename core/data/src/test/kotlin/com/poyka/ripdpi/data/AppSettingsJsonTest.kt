...
class AppSettingsJsonTest {
    ...
    fun `settings round trip through current json format`() {
        val settings =
            AppSettings
                ...
                .setFakeTlsSource(FakeTlsSourceCapturedClientHello)
                .setFakeTlsSecondaryProfile(TlsFakeProfileGoogleChrome)
                .setFakeTcpTimestampEnabled(true)
                .setFakeTcpTimestampDeltaTicks(9)
                ...
                .setRelayOutboundBindIp("192.0.2.15")
                ...
                .addAllRelayAppsScriptScriptIds(listOf("script-a", "script-b"))
                .setRelayAppsScriptGoogleIp("142.250.185.142")
                .setRelayAppsScriptFrontDomain("script.google.com")
                .addAllRelayAppsScriptSniHosts(listOf("script.google.com", "www.google.com"))
                .setRelayAppsScriptVerifySsl(false)
                .setRelayAppsScriptParallelRelay(true)
                .addAllRelayAppsScriptDirectHosts(listOf("youtube.com", "ytimg.com"))
                .setRelayFinalmaskType(RelayFinalmaskTypeFragment)
                .setRelayFinalmaskHeaderHex("abcd")
                .setRelayFinalmaskTrailerHex("ef01")
                .setRelayFinalmaskRandRange("32-96")
                .setRelayFinalmaskSudokuSeed("fixture-seed")
                .setRelayFinalmaskFragmentPackets(3)
                .setRelayFinalmaskFragmentMinBytes(32)
                .setRelayFinalmaskFragmentMaxBytes(96)
                ...
                .addAllAppRoutingEnabledPresetIds(listOf("russian-mainstream", "vk-family"))
    ...
    fun `decoder fills missing values from defaults in current format`() {
        ...
        assertEquals(AppSettingsSerializer.defaultValue.relayAppsScriptVerifySsl, decoded.relayAppsScriptVerifySsl)
