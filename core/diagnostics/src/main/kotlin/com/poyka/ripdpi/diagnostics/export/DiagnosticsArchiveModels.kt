...
internal object DiagnosticsArchiveFormat {
    ...
    fun includedFiles(
        ...
        buildList {
            ...
            add("relay-health-decisions.jsonl")
            add("telemetry.csv")
            if (logcatIncluded) {
                add("logcat.txt")
            }
...
internal fun TelemetrySampleEntity.toArchiveTelemetrySummary(): ArchiveTelemetrySummary =
    ArchiveTelemetrySummary(
        ...
        proxyTelemetryState = proxyTelemetryState,
        proxyTelemetryMessage = proxyTelemetryMessage,
        relayTelemetryState = relayTelemetryState,
        relayTelemetryMessage = relayTelemetryMessage,
        warpTelemetryState = warpTelemetryState,
...
internal data class ArchiveTelemetrySummary(
    ...
    val lastFallbackAction: String? = null,
    val proxyTelemetryState: String? = null,
    val proxyTelemetryMessage: String? = null,
    val relayTelemetryState: String? = null,
    val relayTelemetryMessage: String? = null,
    val warpTelemetryState: String? = null,
    val warpTelemetryMessage: String? = null,
    val tunnelTelemetryState: String? = null,
