...
internal data class PendingDeviceStateEvent(
    ...
    fun toCanonicalMessage(): String =
        buildString {
            ...
            append(" notifications_paused=").append(snapshot.notificationsPaused.wireValue)
            append(" foreground_notification_active=").append(snapshot.foregroundNotificationActive.wireValue)
            append(" foreground_notification_channels=").append(snapshot.foregroundNotificationChannels.wireValue)
            append(" foreground_service_type=").append(snapshot.foregroundServiceType.wireValue)
            append(" user_unlocked=").append(snapshot.userUnlocked.wireValue)
            append(" process_importance=").append(snapshot.processImportance.wireValue)
