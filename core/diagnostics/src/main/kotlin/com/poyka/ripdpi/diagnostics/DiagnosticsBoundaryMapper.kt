    ...
    constructor(
        ...
        fun toDiagnosticTelemetrySample(entity: TelemetrySampleEntity): DiagnosticTelemetrySample =
            DiagnosticTelemetrySample(
                ...
                networkHandoverState = entity.networkHandoverState,
                proxyTelemetryState = entity.proxyTelemetryState,
                proxyTelemetryMessage = entity.proxyTelemetryMessage,
                relayTelemetryState = entity.relayTelemetryState,
                relayTelemetryMessage = entity.relayTelemetryMessage,
                warpTelemetryState = entity.warpTelemetryState,
                warpTelemetryMessage = entity.warpTelemetryMessage,
                tunnelTelemetryState = entity.tunnelTelemetryState,
                tunnelTelemetryMessage = entity.tunnelTelemetryMessage,
