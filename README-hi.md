...
समर्थित तकनीकें: TCP सेगमेंट स्प्लिटिंग और डिसऑर्डर, फ़र्ज़ी पैकेट इंजेक्शन, OOB (urgent pointer), TLS record फ़्रैगमेंटेशन, फ़र्ज़ी TLS first-flight, QUIC handshake विविधता, DTLS फ़िंगरप्रिंट नॉर्मलाइज़ेशन, UDP length-field विविधता, IPv6 extension-header प्रविष्टि, Lua-परिभाषित raw पैकेट प्रेषण, और अनुकूली semantic मार्कर जो लाइव `TCP_INFO` के विरुद्ध स्थिति निर्धारित करते हैं। रणनीति श्रृंखलाएँ इस रिपॉज़िटरी के Rust crates से बनाई जाती हैं, किसी बाहरी रणनीति बाइनरी के बिना।
...
2. **जब नेटवर्क समस्या हो तो स्थानीय पाथ को रूपांतरित करें।** Semantic मार्कर, अनुकूली split प्लेसमेंट, फ़र्ज़ी-payload श्रृंखलाएँ, OOB/disorder, यादृच्छिक TLS records, QUIC और DTLS फ़िंगरप्रिंट विविधता — रिपॉज़िटरी-आंतरिक Rust crates से इकट्ठा किया गया।
...
- **रणनीति नियंत्रण**: TCP split/disorder/fake परिवार, TLS record फ़्रैगमेंटेशन और fake प्रोफ़ाइल, QUIC और DTLS handshake विविधता, UDP length-field विविधता, IPv6 extension headers, Lua `rawsend`, प्रति-step सक्रियण फ़िल्टर, IPv4 ID नियंत्रण, और OOB इंजेक्शन।
...
APK आउटपुट: `app/build/outputs/apk/debug/` और `app/build/outputs/apk/release/`।
