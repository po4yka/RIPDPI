...
Portfolio task `OUT-1786264762917513` owns this change. Add a ripdpi-mieru Rust crate implementing the Mieru outbound client and a MieruProfileScreen editor. Mieru (enfein/mieru) is actively developed and used by Mieru-compatible deployments; omitting it blocks interoperability with that user cohort

## Goals / Non-Goals

- Goal: deliver `Add Mieru outbound client crate and profile editor` with observable evidence.
