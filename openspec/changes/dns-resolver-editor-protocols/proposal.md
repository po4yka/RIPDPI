...
- Save fresh, structurally valid ODoH settings and Proxy-mode DoQ settings for local proxy hostname resolution; block VPN DoQ activation while routed VPN DNS requires SOCKS5.
