...
Portfolio task `RST-1786264762917234` owns this change. Remove the RUSTSEC-2024-0436 waiver by upgrading or replacing the netlink-packet-core path that still pulls paste 1.0.15

## Goals / Non-Goals

- Goal: deliver `Replace unmaintained paste proc-macro dependency` with observable evidence.
