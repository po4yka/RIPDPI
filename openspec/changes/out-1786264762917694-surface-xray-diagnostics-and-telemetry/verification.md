---
task_id: "OUT-1786264762917694"
change: "out-1786264762917694-surface-xray-diagnostics-and-telemetry"
...
|---|---|---|---|
| REQ-OUT-1786264762917694-001 | OUT-1786264762919315 | XrayProviderDiagnosticsTest; XrayProviderSnapshotDeriverTest; XrayProviderStatusScreenshotTest; real E2E version/listener snapshots. Visual presentation is Compose/Roborazzi evidence. | passed |
| REQ-OUT-1786264762917694-002 | OUT-1786264762919585 | XrayProviderDiagnosticsProbeRunnerTest; DiagnosticsXrayProviderControllerTest; both-transports real E2E invokes the production Diagnostics controller with the active real provider and checks report invalidation/unbinding on stop. | passed |
| REQ-OUT-1786264762917694-003 | OUT-1786264762919696 | XrayProviderDiagnosticsTest; DiagnosticsArchiveRendererTest; DiagnosticsDetailAndShareServicesTest; XrayProviderExportContext structural serialized-export allowlist. No blanket redaction claim for user-visible profile labels. | passed |
| REQ-OUT-1786264762917694-004 | OUT-1786264762919411 | XrayProviderDiagnosticsProbeRunnerTest and real Diagnostics action report: safe cached native-worker observations and explicit StatApi N/A; no fresh JNI or remote ping. | passed |
| REQ-OUT-1786264762917694-005 | OUT-1786264762919159 | XrayProviderDiagnosticsTest and XrayProviderStatusScreenshotTest cover five named fixtures; DiagnosticsXrayProviderControllerTest covers stale/absent reports. These are not five live fault injections. | passed |
