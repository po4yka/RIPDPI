...
- [ ] OUT-1786264762917903 Cross-interop against upstream anytls-go is verified and recorded. (deferred: live-server only; offline-infeasible nightly oracle.) #feature @item:OUT-1786264762917551
...
- [ ] OUT-1786264762917917 Main Mode Editor exposes AnyTLS fields instead of relying only on import/profile records. (deferred: AnyTLS is fully configurable via the dedicated AnyTlsProfileScreen + import; exposing it inline is a separate end-to-end "make AnyTLS a se… #feature @item:OUT-1786264762917551
