---
task_id: "OUT-1786264762917829"
change: "out-1786264762917829-add-xray-provider-regression-matrix"
...
|---|---|---|---|
| REQ-OUT-1786264762917829-001 | OUT-1786264762918939 | XrayConfigRendererTest; XrayConfigValidatorTest; XrayImportParserTest; XrayProfileRedactorTest; XrayRedactionRegressionTest. Renderer golden updates were explicitly authorized. | passed |
| REQ-OUT-1786264762917829-002 | OUT-1786264762918174 | XrayServiceLifecycleMatrixTest; RipDpiXrayRuntimeTest; XrayProviderOrchestratorTest; XrayProviderSessionRestartTest; XrayProviderFailureGenerationTest. Failure ownership is unit-tested, positive stop/start is real E2E. | passed |
| REQ-OUT-1786264762917829-003 | OUT-1786264762918618 | XrayProtectFdContractTest; VpnServiceXrayProtectControllerTest; managed Go protection tests; XrayRuntimeInstrumentedTest real protection denial/restart. | passed |
| REQ-OUT-1786264762917829-004 | OUT-1786264762918727 | XrayDnsLoopRegressionTest; XrayTunnelTopologyTest; XrayProviderRouteBuilderTest; VpnUnderlyingNetworkLeaseTest; VpnUnderlyingNetworkBinderTest. Plain UDP DNS is device-tested; hostname bootstrap and MapDNS remain contract evidence. | passed |
| REQ-OUT-1786264762917829-005 | OUT-1786264762918071 | Both XrayProviderE2ETest methods with real libXray/TUN; independent Go peer approved TCP/DNS routes, wrong-identity rejection and direct-sentinel denial. | passed |
| REQ-OUT-1786264762917829-006 | OUT-1786264762918955 | CI xray-native, xray-linked-unit-tests, Android API27/33/35 and API35 independent-peer E2E lanes; exact-method assertions forbid skips; docs/contributor/xray-regression-matrix.md describes environment boundaries. | passed |
