...
- [ ] RTE-1786264762918504 Exclusions verified to persist across VPN reconnects (OS-managed state). DEVICE-GATED — persistence is OS-owned and only observable on a real Android 17 device #feature @item:RTE-1786264762917959
