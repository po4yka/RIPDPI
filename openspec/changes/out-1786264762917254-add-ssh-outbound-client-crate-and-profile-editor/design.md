...
Portfolio task `OUT-1786264762917254` owns this change. Add a ripdpi-ssh Rust crate that opens direct-tcpip forwarding via SSH (password or private-key auth), plus a SshProfileScreen editor

## Goals / Non-Goals

- Goal: deliver `Add SSH outbound client crate and profile editor` with observable evidence.
