...
Portfolio task `EPC-1786264762917329` owns this change. Add a first remote VPN-client provider mode to RIPDPI by embedding xray-core through libXray, with VLESS/REALITY and XHTTP as the initial profile targets

## Goals / Non-Goals

- Goal: deliver `Epic - Xray provider mode` with observable evidence.
