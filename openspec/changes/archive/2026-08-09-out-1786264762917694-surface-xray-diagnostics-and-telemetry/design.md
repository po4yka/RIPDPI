...
Portfolio task `OUT-1786264762917694` owns this change. Expose Xray provider state in Home, Diagnostics, exports, and service telemetry

## Goals / Non-Goals

- Goal: deliver `Surface Xray diagnostics and telemetry` with observable evidence.
