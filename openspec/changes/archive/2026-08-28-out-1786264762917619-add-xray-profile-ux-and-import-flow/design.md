...
Portfolio task `OUT-1786264762917619` owns this change. Add the user-facing flow for selecting Xray VPN mode and importing or editing initial Xray profiles

## Goals / Non-Goals

- Goal: deliver `Add Xray profile UX and import flow` with observable evidence.
