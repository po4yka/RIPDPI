...
Portfolio task `OUT-1786264762917829` owns this change. Add focused automated coverage for the first Xray provider integration

## Goals / Non-Goals

- Goal: deliver `Add Xray provider regression matrix` with observable evidence.
