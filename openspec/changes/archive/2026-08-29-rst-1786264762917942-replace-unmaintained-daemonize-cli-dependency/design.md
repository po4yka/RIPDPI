...
Portfolio task `RST-1786264762917942` owns this change. Remove the RUSTSEC-2025-0069 waiver by replacing daemonize 0.5.0 in the local ripdpi-cli process mode while keeping the dependency outside every Android runtime graph

## Goals / Non-Goals

- Goal: deliver `Replace unmaintained daemonize CLI dependency` with observable evidence.
