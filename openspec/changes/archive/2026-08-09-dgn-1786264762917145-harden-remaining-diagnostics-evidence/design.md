...
Portfolio task `DGN-1786264762917145` owns this change. Close the confirmed source-side diagnostics gaps left after the P0, P1, and P2 waves without claiming physical-device or dual-vantage evidence that was not observed

## Goals / Non-Goals

- Goal: deliver `Harden remaining diagnostics evidence` with observable evidence.
