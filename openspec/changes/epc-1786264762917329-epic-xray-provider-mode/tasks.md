...
- [ ] EPC-1786264762918997 Home, Diagnostics, and Settings show typed Xray provider state. — the typed provider-state substrate (XrayProviderSnapshot, XrayConnectionStage, failure classes, redacted summaries) AND the :core:service live-population backend now both la… #epic !high @item:EPC-1786264762917329
- [ ] EPC-1786264762918562 Lifecycle, config, protect-fd, telemetry, and smoke tests cover the first internal build. — lifecycle, config, protect-fd, DNS-loop, and telemetry tests are green offline; the device/emulator egress smoke remains OPEN (blocked on gomobile/… #epic !high @item:EPC-1786264762917329
