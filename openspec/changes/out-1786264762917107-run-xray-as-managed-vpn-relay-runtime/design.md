...
Portfolio task `OUT-1786264762917107` owns this change. Implement a supervised Xray runtime that starts, reports readiness, exposes health, and stops cleanly inside RIPDPI's Android service layer

## Goals / Non-Goals

- Goal: deliver `Run Xray as managed VPN relay runtime` with observable evidence.
