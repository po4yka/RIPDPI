...
use ciadpi_desync::{
    ...
    resolve_hostfake_span, ActivationContext, ActivationTransport, DesyncAction, DesyncPlan,
};
use ciadpi_session::{
...
mod tests {
    ...
    fn read_socks5_request_reads_domain_target() {
        ...
        let request = [
            S_VER5, S_CMD_CONN, 0, 0x03, 11, b'e', b'x', b'a', b'm', b'p', b'l', b'e', b'.', b'c',
            b'o', b'm', 0x01, 0xbb,
        ];
    ...
    fn parse_shadowsocks_target_handles_ipv4_and_resolved_domain_targets() {
        ...
        let domain_packet = [
            0x03, 9, b'1', b'2', b'7', b'.', b'0', b'.', b'0', b'.', b'1', 0x00, 0x50,
        ];
    ...
    fn parse_shadowsocks_target_respects_ipv6_and_resolve_flags() {
        ...
        let domain_packet = [
            0x03, 9, b'1', b'2', b'7', b'.', b'0', b'.', b'0', b'.', b'1', 0, 80,
        ];
