...
struct SSL3_STATE {
  ...
  // client_random_overridden is set by SSL_set_client_random to suppress the
  // RAND_bytes() call in ssl3_send_client_hello, preserving the pre-seeded
  // value through the initial handshake.
  bool client_random_overridden = false;
