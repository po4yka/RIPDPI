...
pub(crate) mod util {
    ...
    pub use ripdpi_diagnostics_contracts::util::{
        ...
        TLS_FAKE_PROFILE_GOOGLE_CHROME_HRR, UDP_FAKE_PROFILE_DNS_QUERY, active_scan_io_deadline,
        bounded_scan_io_timeout, classify_dns_answer_overlap, classify_probe_outcome, default_diagnosis_severity,
        ...
        probe_session_seed, ranged_probe_delay, stable_probe_hash, with_scan_io_deadline,
    };
}
