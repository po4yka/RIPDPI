...
impl ConnectError {
    pub fn to_reply_error(&self) -> ReplyError {
        match self {
            ...
            ConnectError::ConnectionAborted(_) | ConnectError::ConnectionReset(_) => ReplyError::ConnectionNotAllowed,
...
pub async fn tcp_connect_with_timeout<T>(addr: T, request_timeout: Duration) -> Result<TcpStream, ConnectError>
where
    T: ToSocketAddrs,
{
