...
pub use types::{
    ...
    ProxyUiChainConfig, ProxyUiConfig, ProxyUiDestinationDomainMatcher, ProxyUiDestinationDomainMatcherKind,
    ProxyUiDestinationIpMatcher, ProxyUiDestinationIpMatcherKind, ProxyUiDestinationPortRange,
    ProxyUiDestinationRoutingAction, ProxyUiDestinationRoutingConfig, ProxyUiDestinationRoutingNetwork,
    ProxyUiDestinationRoutingRule, ProxyUiFakePacketConfig, ProxyUiHostAutolearnConfig, ProxyUiHostsConfig,
