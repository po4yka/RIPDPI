...
fn emitted_native_outcome_tokens() -> BTreeSet<String> {
    ...
    for (path, signature) in [
        ("native/rust/crates/ripdpi-diagnostics-probes/src/connectivity/probes.rs", "pub fn run_dns_probe"),
        ("native/rust/crates/ripdpi-diagnostics-probes/src/connectivity/probes.rs", "fn classify_dns_probe_outcome"),
        ("native/rust/crates/ripdpi-diagnostics-probes/src/connectivity/probes.rs", "pub fn run_domain_probe"),
        ("native/rust/crates/ripdpi-diagnostics-probes/src/connectivity/probes.rs", "pub fn run_tcp_probe"),
        ("native/rust/crates/ripdpi-diagnostics-probes/src/connectivity/probes.rs", "pub fn run_quic_probe"),
        ("native/rust/crates/ripdpi-diagnostics-probes/src/connectivity/probes.rs", "pub fn run_service_probe"),
        ("native/rust/crates/ripdpi-diagnostics-probes/src/connectivity/probes.rs", "pub fn run_circumvention_probe"),
        ("native/rust/crates/ripdpi-diagnostics-probes/src/connectivity/probes.rs", "pub fn run_throughput_probe"),
        (
            "native/rust/crates/ripdpi-diagnostics-probes/src/connectivity/report.rs",
            "pub fn build_network_environment_probe",
        ),
        ("native/rust/crates/ripdpi-monitor-engine/src/execution.rs", "pub fn run_http_strategy_probe"),
        ("native/rust/crates/ripdpi-monitor-engine/src/execution.rs", "pub fn run_https_strategy_probe"),
        ("native/rust/crates/ripdpi-monitor-engine/src/execution.rs", "pub fn run_quic_strategy_probe"),
        ("native/rust/crates/ripdpi-diagnostics-probes/src/telegram.rs", "fn classify_telegram_verdict"),
        ("native/rust/crates/ripdpi-diagnostics-probes/src/telegram.rs", "pub fn run_telegram_probe"),
        ("native/rust/crates/ripdpi-diagnostics-probes/src/fat_header.rs", "pub fn classify_fat_header_outcome"),
    ] {
