pub(crate) mod dns {
    pub use ripdpi_diagnostics_protocols::dns::{
        ...
        resolve_via_encrypted_dns_with_raw, resolve_via_udp_with_raw,
    };
}

pub(crate) mod dns_analysis {
    pub use ripdpi_diagnostics_protocols::dns_analysis::{
        analyze_dns_response, compare_dns_responses, parse_record_set,
    };
}
