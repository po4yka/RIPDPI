...
pub use http::{
    http_marker_info, is_http, is_http_redirect, mod_http_inplace, mod_http_like_c, parse_http,
    second_level_domain_span,
};
pub use quic::{
...
pub use tls::{
    change_tls_sni_seeded_like_c, duplicate_tls_session_id_inplace, duplicate_tls_session_id_like_c,
    is_tls_client_hello, is_tls_server_hello, padencap_tls_into, padencap_tls_like_c, parse_tls, part_tls_like_c,
    randomize_tls_seeded_inplace, randomize_tls_seeded_like_c, randomize_tls_sni_seeded_inplace,
    randomize_tls_sni_seeded_like_c, tls_marker_info, tls_session_id_mismatch, tune_tls_padding_size_into,
    tune_tls_padding_size_like_c,
};
pub use types::{
