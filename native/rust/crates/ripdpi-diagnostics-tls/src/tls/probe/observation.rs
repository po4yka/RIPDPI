...
use super::super::types::{ProbeStreamResult, TlsClientProfile, TlsObservation};
use super::ech;
...
pub(crate) fn from_probe_error(err: String, profile: TlsClientProfile) -> TlsObservation {
    if let Some(outcome) = ech::from_resolution_error(&err, profile) {
