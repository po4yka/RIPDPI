...
pub mod compat {
    ...
    pub mod util {
        pub use ripdpi_diagnostics_contracts::util::{
            ...
            ProbeOutcomeClassification, CONNECT_TIMEOUT, DEFAULT_DNS_SERVER, DEFAULT_DOH_BOOTSTRAP_IPS,
            DEFAULT_DOH_HOST, DEFAULT_DOH_PORT, DEFAULT_DOH_URL, FAT_HEADER_REQUESTS, FAT_HEADER_THRESHOLD_BYTES,
    ...
    pub mod wire {
        pub use ripdpi_diagnostics_contracts::wire::{
            EngineObservationWire, EngineProbeResultWire, EngineProbeTaskFamily, EngineProbeTaskWire,
            EngineProgressWire, EngineScanReportWire, EngineScanRequestWire, ResolverRecommendationWire,
