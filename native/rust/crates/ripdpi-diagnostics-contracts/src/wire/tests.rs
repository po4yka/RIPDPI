...
use crate::types::{
    ...
    ObservationKind, ProbeObservation, ProbeTaskFamily, STRATEGY_PROBE_ATTEMPT_VERSION,
    STRATEGY_PROBE_METHODOLOGY_VERSION, ScanKind, ScanPathMode, StrategyCandidatePlanSnapshot, StrategyEmitterTier,
    StrategyExecutionPlanSnapshot, StrategyProbeAttempt, StrategyProbeAttemptRound, StrategyProbeAttemptStatus,
...
fn diagnostics_scan_report_field_manifest_matches_contract_fixture() {
    ...
    let report = EngineScanReportWire {
        ...
        strategy_probe_report: Some(StrategyProbeReport {
            ...
            attempts: vec![StrategyProbeAttempt {
                attempt_version: STRATEGY_PROBE_ATTEMPT_VERSION.to_string(),
                sequence: 1,
                candidate_index: 1,
                candidate_id: "baseline_current".to_string(),
                candidate_label: "Current strategy".to_string(),
                candidate_family: "baseline_current".to_string(),
                lane: StrategyProbeProgressLane::Tcp,
                target: "www.youtube.com".to_string(),
                target_index: 1,
                is_control: true,
