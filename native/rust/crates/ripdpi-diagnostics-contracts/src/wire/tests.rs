...
use crate::types::{
    ...
    StrategyProbeRecommendation, StrategyProbeReport, StrategyProbeResponseStage, StrategyProbeRouteFeature,
    StrategyProbeTargetSelection, StrategyTlsPreludeKind, StrategyUdpIpv6ExtensionProfile, TransportFamily,
    ...
    let report = EngineScanReportWire {
        ...
        strategy_probe_report: Some(StrategyProbeReport {
            ...
            tcp_candidates: vec![StrategyProbeCandidateSummary {
                ...
                runtime_terminal_status: crate::types::StrategyProbeRuntimeTerminalStatus::CleanShutdown,
                execution_evidence_complete: true,
                execution_attempts: vec![StrategyProbeAttemptExecutionEvidence {
                    probe_succeeded: true,
                    complete: true,
                    response_stage: StrategyProbeResponseStage::ResponseObserved,
                    receipts: vec![StrategyDesyncExecutionReceipt {
                        ...
                        configured_family: Some(StrategyExecutionFamily::TlsRecordSplit),
                        effective_family: Some(StrategyExecutionFamily::TlsRecordSplit),
                        marker_base: Some(StrategyOffsetMarkerBase::Host),
                        marker_delta: Some(1),
                        resolved_offset: Some(42),
                        planned_steps: 1,
                        attempted_actions: 3,
                        completed_actions: 3,
                        real_writes_committed: 2,
                        completed_awaits: 1,
                        payload_bytes_committed: 128,
                        tls_record_prelude_applied: true,
                        tls_prelude_configured_count: 1,
                        tls_prelude_applied_count: 1,
                        tls_prelude_kind: Some(StrategyTlsPreludeKind::TlsRec),
                        tls_prelude_marker_base: Some(StrategyOffsetMarkerBase::ExtLen),
                        tls_prelude_marker_delta: Some(0),
                        tls_prelude_resolved_offset: Some(37),
                        udp_ipv6_extension_profile: None,
                        fallback_reason: None,
                        terminal_reason: None,
                    }],
                }],
                route_features: vec![StrategyProbeRouteFeature::UpstreamRelay],
            }],
            quic_candidates: vec![StrategyProbeCandidateSummary {
                id: "quic_ipfrag2_profiled".to_string(),
                label: "QUIC profiled fragmentation".to_string(),
                family: "quic_ipfrag2_ipv6_ext".to_string(),
                emitter_tier: crate::types::StrategyEmitterTier::NonRootProduction,
                exact_emitter_requires_root: false,
                emitter_downgraded: false,
                quic_layout_family: None,
                ...
                execution_attempts: vec![StrategyProbeAttemptExecutionEvidence {
                    ...
                    receipts: vec![StrategyDesyncExecutionReceipt {
                        connection_ordinal: 1,
                        transport: crate::types::StrategyExecutionTransport::Udp,
                        disposition: StrategyExecutionDisposition::Applied,
                        configured_family: Some(StrategyExecutionFamily::QuicIpFragment2),
                        effective_family: Some(StrategyExecutionFamily::QuicIpFragment2),
                        marker_base: None,
                        marker_delta: None,
                        ...
                        udp_ipv6_extension_profile: Some(StrategyUdpIpv6ExtensionProfile::HopByHopDestinationOptions),
                        fallback_reason: None,
                        terminal_reason: None,
                    }],
                }],
            ...
            recommendation: Some(StrategyProbeRecommendation {
                tcp_candidate_id: "baseline_current".to_string(),
                tcp_candidate_label: "Current strategy".to_string(),
                quic_candidate_id: "quic_ipfrag2_profiled".to_string(),
                quic_candidate_label: "QUIC profiled fragmentation".to_string(),
            ...
            active_path_observation: Some(StrategyActivePathObservation {
                role: crate::types::StrategyProbeObservationRole::ActiveServiceInPath,
                response_stage: StrategyProbeResponseStage::ResponseObserved,
                active_path_authority: StrategyActivePathAuthority::OwnedRouteLeaseAtScan,
                attempted_targets: 2,
                route_reached_targets: 1,
