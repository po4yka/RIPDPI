...
description: Audits unsafe Rust blocks for undefined behavior, runs Miri validation, and categorizes risk. Use when adding or changing unsafe code, or for periodic safety audits.
