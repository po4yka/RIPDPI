---
name: golden-blesser
description: Bless, diff-review, and triage golden test fixtures (Roborazzi, telemetry/logging, wire-contract, Rust contract_fixtures). Use when golden tests fail or you need to decide bless-vs-bug.
