...
https://github.com/chrisbanes/skills/blob/main/skills/compose-state-hoisting/SKILL.md
...
- `references/state-management.md` — correct local `remember` and mutable state authoring.
- `references/state-holder-vs-viewmodel.md` — split screen state-holder wiring from plain state-driven UI rendering.
- `references/side-effects.md` — choose effect APIs and composition-scoped coroutine boundaries.
