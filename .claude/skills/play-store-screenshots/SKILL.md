...
| Feature list | 1. DPI bypass (proxy + VPN modes) 2. No root required 3. Advanced strategy controls (TCP, QUIC, DNS) 4. Encrypted DNS (DoH/DoT/DNSCrypt) 5. Integrated diagnostics & monitoring 6. Per-network policies 7. Works with AdGuard 8. Session telemetry & export |
...
- **Promotional text**: "Best DPI bypass 2026" or "Free for limited time"
